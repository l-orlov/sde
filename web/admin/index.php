...
<head>
    ...
    <link rel="stylesheet" href="<?= $basePath ?>css/style.css?v=<?= asset_version('admin/css/style.css') ?>">
    <link rel="stylesheet" href="<?= $basePath ?>css/styleA.css?v=<?= asset_version('admin/css/styleA.css') ?>">
</head>
