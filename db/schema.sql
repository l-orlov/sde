...
CREATE TABLE `companies` (
  ...
  `organization_type_en` varchar(100) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `annual_export_en` varchar(100) DEFAULT NULL,
  `certifications` text DEFAULT NULL,
  `certifications_en` text DEFAULT NULL,
  `created_at` int(10) unsigned NOT NULL DEFAULT unix_timestamp(),
  `updated_at` int(10) unsigned NOT NULL DEFAULT unix_timestamp(),
  `deleted_at` int(10) unsigned DEFAULT NULL COMMENT 'Unix timestamp when soft-deleted; NULL = not deleted',
  `current_markets_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`current_markets_en`)),
  `target_markets_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`target_markets_en`)),
  PRIMARY KEY (`id`),
